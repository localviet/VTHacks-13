        ...
        <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Register your business to join Ignite — share your website and
              grow your presence.
            </p>
          </div>
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              axios
                .request({
                  method: "POST",
                  url: `${import.meta.env.VITE_API_URL}/api/register/corp`,
                  headers: {
                    "Content-Type": "application/json",
                  },
                  data: { businessName, email, password, website },
                })
                .then((res) => {
          ...
          >
            ...
            {success && (
              <div className="text-sm text-green-600">
                Business account created — check your email.
              </div>
            )}
          </form>
