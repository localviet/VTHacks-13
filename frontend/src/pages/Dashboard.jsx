...
export default function IgniteDashboard() {
  ...
  const stats = [
    ...
    { label: "Money Earned", value: "$5,847", icon: DollarSign, change: "+15.3%", color: "bg-purple-500" },
  ];
  ...
  const offers = [
    ...
    { brand: "Netflix", amount: "$1,800", status: "Review", deadline: "Dec 18" },
  ];
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                        <span className="text-white font-bold text-sm">{offer.brand[0]}</span>
                      </div>
                      <div>
                        <h3 className="font-semibold text-gray-900">{offer.brand}</h3>
                        <p className="text-gray-600 text-sm">Due: {offer.deadline}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-2xl font-bold text-gray-900">{offer.amount}</span>
